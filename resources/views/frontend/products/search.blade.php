...
<div class="header-search-title">
    ...
    @if(count($data['books']) <= 0) <p
        style="display:flex; justify-content:center; width:100%; align-items: center; height: 60px;">Không tìm thấy kết
        quả nào nhưng bạn hãy tham khảo sách dưới đây nhé!
        </p>
        @endif
</div>
