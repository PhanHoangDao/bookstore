...
class HomeController extends Controller
{
    ...
    private function loadDetailForProductSearch($booksArray)
    {
        $books = [];
    ...
    public function searchByMenu(Request $request)
    {
        ...
        $books = $this->loadDetailForProductSearch($booksArray);
        $dataNew = session('data');
        $dataNew['books'] = $books;
    ...
    public function search(Request $request)
    {
        ...
        if (count($booksArray) <= 0) {
            ...
            $booksNew = $this->loadDetailForProductSearch($booksNew);
